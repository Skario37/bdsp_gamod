...
def RandomizeTrainer(p, env):
    print(" - Randomizing trainers.")
            ...
            if tree["m_Name"] == "TrainerTable":
                for mon in tree["TrainerPoke"]:
                    for n in range(1, 7):
                        ...
                        if level > 0:
                            mon["P"f"{n}MonsNo"] = random.choice(p["pool"]["mon"])
